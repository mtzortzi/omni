"""Audit every live ADO Feature for a missing hierarchy parent."""
...
def main() -> None:
    ...
    print(f"project_features={len(items)} parentless={len(orphans)} physical_ai_parentless={len(physical_ai)}")
